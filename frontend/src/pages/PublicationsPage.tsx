...
export default function PublicationsPage() {
  ...
  const isOwner = (pub: ResearchPublication) => user && pub.created_by === user.id;
  const isAuthor = (pub: ResearchPublication) => user?.full_name && (pub.autores || '').toLowerCase().includes(user.full_name.toLowerCase());
